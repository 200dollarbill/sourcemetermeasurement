classdef ControllerGUINew < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        MeasuredelaysEditField         matlab.ui.control.NumericEditField
        MeasuredelaysEditFieldLabel    matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        function StartButtonPushed(app, event)
            ...
            measure_delay_T = app.MeasuredelaysEditField.Value;
            
            if measure_delay_T > step_T
                measure_delay_T = step_T;
            end
            pause_after_measure_T = step_T - measure_delay_T;
            ...
            for i = 1:length(I_steps)
                ...
                % Pause for measurement delay
                pause(measure_delay_T);
                ...
                % Pause for the remaining step time
                if pause_after_measure_T > 0
                    pause(pause_after_measure_T);
                end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Position = [100 100 1147 837];
            app.UIFigure.Name = 'MATLAB App';

            % Create TabGroup
            app.TabGroup = uitabgroup(app.UIFigure);
            app.TabGroup.Position = [310 20 820 790];
            ...
            ylabel(app.UIAxes, 'Measured Resistance (Ohms)')
            zlabel(app.UIAxes, 'Z')
            app.UIAxes.Position = [14 80 782 664];
            ...
            app.UIAxes2.Position = [15 80 781 664];
            ...
            app.SettingsPanel.Position = [25 152 265 387];
            ...
            app.StartCurrentAEditFieldLabel.Position = [18 265 93 22];
            ...
            app.StartCurrentAEditField.Position = [139 265 100 22];
            ...
            app.SupplyAddrEditFieldLabel_3.Position = [19 233 89 22];
            ...
            app.SupplyAddrEditField_4.Position = [139 233 100 22];
            ...
            app.StepsizeAEditFieldLabel.Position = [19 203 74 22];
            ...
            app.StepsizeAEditField.Position = [139 203 100 22];
            ...
            app.SavetoExcelButton.Position = [18 15 220 33];
            ...
            app.SteptimesEditFieldLabel.Position = [19 162 73 22];
            ...
            app.SteptimesEditField.Position = [139 162 100 22];
            ...
            app.FilenameEditField_2Label.Position = [19 82 54 22];
            ...
            app.FilenameEditField_2.Position = [139 82 100 22];
            ...
            app.StartCurrentAEditFieldLabel_2.Position = [23 329 89 22];
            ...
            app.StartCurrentAEditField_2.Position = [140 329 100 22];
            ...
            app.StartCurrentAEditFieldLabel_3.Position = [29 297 83 22];
            ...
            app.StartCurrentAEditField_3.Position = [140 297 100 22];
            ...
            app.HysteresisCheckBox.Position = [24 54 78 22];

            % Create MeasuredelaysEditFieldLabel
            app.MeasuredelaysEditFieldLabel = uilabel(app.SettingsPanel);
            app.MeasuredelaysEditFieldLabel.HorizontalAlignment = 'right';
            app.MeasuredelaysEditFieldLabel.Position = [20 130 101 22];
            app.MeasuredelaysEditFieldLabel.Text = 'Measure delay (s)';

            % Create MeasuredelaysEditField
            app.MeasuredelaysEditField = uieditfield(app.SettingsPanel, 'numeric');
            app.MeasuredelaysEditField.Position = [140 130 100 22];
            app.MeasuredelaysEditField.Value = 0.2;

            % Create ControlPanel
            app.ControlPanel = uipanel(app.UIFigure);
            app.ControlPanel.Title = 'Control';
            app.ControlPanel.Position = [26 21 265 122];
