...
def process_directory(base_dir):
    # Find all Excel files in the board subdirectories
    ...
    print("======================================================")
    print("           FULL SENSOR RESPONSE ANALYSIS")
    print("======================================================\n")

    for file in sorted(excel_files):
        # Ignore temporary lock files and analysis folders
        ...
        try:
            ...
            # Skip corrupted/bad format files silently to keep output clean
            pass
